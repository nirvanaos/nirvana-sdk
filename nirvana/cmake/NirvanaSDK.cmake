...
function (nirvana_module module_name)
	...
	if (arg_IDL_FILES)
		set (args ${module_name} IDL_FILES ${arg_IDL_FILES} OPTIONS ${idl_options})
		if (arg_OUT_H)
			list (APPEND args OUT_H ${arg_OUT_H})
		endif ()
		if (arg_IDL_ROOT)
			list (APPEND args IDL_ROOT ${arg_IDL_ROOT})
		endif ()
		nirvana_compile_idl (${args})
	endif ()
